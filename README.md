...
- <b>Easier	page scrolling</b>
- <b>Optimized CPU, GPU, and RAM utilization</b>
...
- Basilisk
- PowerFox
- Any other Mozilla browser built on the UXP codebase; non-UXP Mozilla browsers are not 
officially supported (inc. Firefox, Waterfox, etc.)
